...

{
    ...
    "title": "@state",
    "category": "section",
    "text": "We changed how to specify state variables.@state(subproblem, 0 <= x <= 1, x0==2)\n\n# becomes\n\n@variable(subproblem, 0 <= x <= 1, Kokako.State, initial_value = 2)In addition, instead of having to create an incoming state x0 and an outgoing state x, we now refer to x.in and x.out. Here is another example:@state(subproblem, 0 <= x[i=1:2] <= 1, x0==i)\n\n# becomes\n\n@variable(subproblem, 0 <= x[i=1:2] <= 1, Kokako.State, initial_value = i)\n\nx0[1]\n\n# becomes\n\nx[1].in\n\nx[2]\n\n# becomes\n\nx[2].out"
},
...

{
    ...
    "category": "section",
    "text": "@stageobjective no longer accepts a random list of parameters. Use Kokako.parameterize instead.@stageobjective(subproblem, ω = [1, 2, 3], ω * x)\nsetnoiseprobability!(subproblem, [0.5, 0.2, 0.3])\n\n# becomes\n\nKokako.parameterize(subproblem, [1, 2, 3], [0.5, 0.2, 0.3]) do ω\n    @stageobjective(subproblem, ω * x)\nend"
},

{
    ...
    "title": "SDDP.solve",
    "category": "section",
    "text": "SDDP.solve has been replaced by Kokako.train. See the docs for a complete list of the new options as most things have changed.note: Note\nParallel training has not (yet) been implemented."
},
...

{
    ...
    "title": "Expectation",
    "category": "section",
    "text": "Kokako.ExpectationKokako.adjust_probability(\n    Kokako.Expectation(),\n    risk_adjusted_probability,\n    nominal_probability,\n    noise_supports,\n    cost_realizations,\n    is_minimization\n)\n\nrisk_adjusted_probability\n\n# output\n\n4-element Array{Float64,1}:\n 0.1\n 0.2\n 0.3\n 0.4Kokako.Expectation is the default risk measure in SDDP.jl."
},
...
{
    "location": "apireference/#Kokako.numerical_stability_report",
    "page": "Reference",
    "title": "Kokako.numerical_stability_report",
    "category": "function",
...

{
    ...
    "category": "section",
    "text": "Kokako.numerical_stability_report\nKokako.train\nKokako.termination_status"
},
